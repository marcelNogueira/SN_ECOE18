...
<title>Consultar Habilidade</title>
</head>
<body>
<div id="tudo">
<div id="navegacao">
...
<div id="conteudo2">
	<% 
		...
		if(h!=null){
			out.println("<h3>Buscar Habilidade</h3>");
			...
			out.println("<div><label>Descrição</label></div>");
			out.println("<div><input type=\"text\" name=\"descricao\" readonly=\"true\" size=\"50\" value=\""+h.getDescricao()+"\"/></div>");		
			out.println("<div class=\"send-button\"><input type=\"submit\" value=\"Ok\"/></div>");
			out.println("</form>");
		}else{
			out.println("<h3>Nome de acessório não existe!</h3>");			
		}
	%>
</div>
</div>
...
<div id="rodape-tudo">
	...
	<p>José Marcel Mendes Nogueira - 2016</p>
</div>
</div>
</body>
</html>